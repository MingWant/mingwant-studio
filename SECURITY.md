...
请不要通过公开 Issue 披露尚未修复的漏洞。项目发布到自有 Git 仓库后，应启用 Private vulnerability reporting 并在此补充维护者安全邮箱。确认属于未修改上游代码的问题，也可通过 [Open AI Canvas 的私密漏洞通道](https://github.com/ddcat-ai/open-ai-canvas/security/advisories/new) 告知上游维护者。
