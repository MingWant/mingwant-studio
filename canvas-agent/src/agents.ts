...
class CodexAppClient {
    ...
    static async start(emit: AgentEmit) {
        ...
        await client.request("initialize", { clientInfo: { name: "canvas-agent", title: "明想 MingWant Canvas Agent", version: VERSION }, capabilities: { experimentalApi: true, requestAttestation: false } });
