...
func validAssetCategory(category model.AssetCategory) bool {
	switch category {
	case model.AssetCategoryCharacter, model.AssetCategoryEnvironment, model.AssetCategoryWardrobe, model.AssetCategoryProp, model.AssetCategoryWeapon, model.AssetCategoryStyle, model.AssetCategoryProduct, model.AssetCategoryBrand, model.AssetCategoryRights, model.AssetCategoryOther:
		return true
	default:
		return false
	}
