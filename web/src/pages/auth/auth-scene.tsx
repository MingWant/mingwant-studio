    ...
    return (
        <main className="h-dvh min-h-0 overflow-y-auto bg-[#08090c] text-white lg:overflow-hidden">
            <div className="grid min-h-full lg:h-full lg:grid-cols-[minmax(0,1.32fr)_minmax(520px,1fr)]">
                <section className="relative min-h-[250px] overflow-hidden sm:min-h-[320px] lg:min-h-0" aria-label="明想 MingWant Studio 品牌影片">
                    <video
                    ...
                    >
                        <p className="text-xs font-semibold tracking-[0.18em] text-white/58">MINGWANT STUDIO</p>
                        <h1 className="mt-3 max-w-xl text-3xl font-semibold leading-tight sm:text-4xl lg:text-5xl">让真实素材，生长为可投放的商业内容。</h1>
                    </motion.div>
                </section>
