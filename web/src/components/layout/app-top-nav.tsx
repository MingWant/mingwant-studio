            ...
            <div className="flex h-dvh min-h-0 w-full overflow-hidden">
                {!hideChrome ? (
                    <aside className={cn("app-workspace-sidebar flex shrink-0 flex-col overflow-hidden", mobileSidebarExpanded ? "w-[196px]" : "w-[52px]", compactSidebar ? "lg:w-[60px]" : "lg:w-[220px]")}>
                        ...
                        >
                            <Link to="/" className={cn("min-w-0 items-center gap-2", mobileSidebarExpanded ? "flex" : "hidden", compactSidebar ? "lg:hidden" : "lg:flex")} title="明想 MingWant Studio">
                                ...
                                <span className="truncate text-[13px] font-semibold">明想 <span className="text-[10px] font-medium text-foreground/45">MingWant</span></span>
                            </Link>
                            <button
                                type="button"
